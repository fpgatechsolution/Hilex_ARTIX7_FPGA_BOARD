...
vlog -work xpm  -incr -sv "+incdir+../../../ipstatic" "+incdir+../../../../../vga_test/vga_test.gen/sources_1/ip/clk_wiz_0" \
"C:/Vitis/Vivado/2020.2/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \

vcom -work xpm  -93 \
"C:/Vitis/Vivado/2020.2/data/ip/xpm/xpm_VCOMP.vhd" \

vlog -work xil_defaultlib  -incr "+incdir+../../../ipstatic" "+incdir+../../../../../vga_test/vga_test.gen/sources_1/ip/clk_wiz_0" \
